...
interface MessageListProps {
    ...
    composerLayout?: "fixed" | "inline"
}

const LAUNCH_SOUND_URL = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/launch-SUi0itAGHr1wtvdDYYG5bzFLsIYHtP.mp3"

export function MessageList({ messages, isStreaming, error, onRetry, isLoaded, composerLayout = "fixed" }: MessageListProps) {
    ...
    return (
        <div
            ...
            className={`absolute inset-0 overflow-y-auto pt-16 space-y-4 border-none px-6 ${composerLayout === "fixed" ? "pb-32" : "pb-6"}`}
            role="log"
